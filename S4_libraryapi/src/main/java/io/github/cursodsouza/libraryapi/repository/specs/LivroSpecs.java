package io.github.cursodsouza.libraryapi.repository.specs;
...
public class LivroSpecs {
    ...
    public static Specification<Livro> tituloLike(String titulo){
        // upper(livro.titulo) like(%:param%) abaixo tbm para procurar a str em qualquer lugar no titulo.
